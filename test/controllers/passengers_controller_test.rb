...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { job_id: @passenger.job_id, ride_id: @passenger.ride_id, user_id: @passenger.user_id }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { job_id: @passenger.job_id, ride_id: @passenger.ride_id, user_id: @passenger.user_id }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
